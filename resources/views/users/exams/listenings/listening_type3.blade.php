...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <h5 class="mt-4">Listening (3) {{ $question->title != null ? $question->title : '' }}</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('user.student_answers_listenings.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        @if ($question->answer_photo1)
                                            <div class="text-center">
                                                <img src="{{ asset('photos/questions/listening_one/' . $question->answer_photo1) }}"
                                                    alt=""
                                    ...
                                    <div class="col-sm-3">
                                        @if ($question->answer_photo2)
                                            <div class="text-center">
                                                <img src="{{ asset('photos/questions/listening_two/' . $question->answer_photo2) }}"
                                                    alt=""
                                                    class="question-img img-thumbnail shadow p-3 mb-5 bg-body rounded"
                                                    style="width:150px;height:150px;">
                                            </div>
                                    ...
                                    <div class="col-sm-3">
                                        @if ($question->answer_photo3)
                                            <div class="text-center">
                                                <img src="{{ asset('photos/questions/listening_three/' . $question->answer_photo3) }}"
                                                    alt=""
                                                    class="question-img img-thumbnail shadow p-3 mb-5 bg-body rounded"
                                                    style="width:150px;height:150px;">
                                            </div>
                                    ...
                                    <div class="col-sm-3">
                                        @if ($question->answer_photo4)
                                            <div class="text-center">
                                                <img src="{{ asset('photos/questions/listening_four/' . $question->answer_photo4) }}"
                                                    alt=""
                                                    class="question-img img-thumbnail shadow p-3 mb-5 bg-body rounded"
                                                    style="width:150px;height:150px;">
                                            </div>
        ...
        <div class="row my-3">
            <div class="col-sm-12 text-center">
                ...
                <a href="{{ route('user.examListeningType2') }}" class="text-decoration-none">
                    <button type="button" class="btn btn-md btn-outline-primary"><i
                            class="fas fa-angle-double-left"></i></button>
                </a>

                <a href="{{ route('user.examListeningType4') }}">
                    <button type="button" class="btn btn-md btn-outline-primary"><i
