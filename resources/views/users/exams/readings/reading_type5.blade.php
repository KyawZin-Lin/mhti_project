...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <h5 class="mt-4">Reading (5) {{ $question->title != null ? $question->title : '' }}</h5>
            @forelse ($questions as $question)
                <div class="col-sm-12">
                    <div class="card my-3">
                        <div class="card-body">
                            <h4><b>{{ $loop->index + 1 }} . {{ $question->title }}</b></h4>
                            <h6 class="q-name">{{ $question->question_name }}</h6>
        ...
        <div class="row my-3">
            <div class="col-sm-12 text-center">
                ...
                <a href="{{ route('user.examReadingType4') }}" class="text-decoration-none">
                    <button type="button" class="btn btn-md btn-outline-primary"><i
                            class="fas fa-angle-double-left"></i></button>
                </a>

                <a href="{{ route('user.examReadingType6') }}">
                    <button type="button" class="btn btn-md btn-outline-primary"><i
