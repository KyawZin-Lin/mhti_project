...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <h5 class="mt-4">Reading (6) {{ $question->title != null ? $question->title : '' }}</h5>
        ...
        <div class="row my-3">
            <div class="col-sm-12 text-center">
                ...
                <a href="{{ route('user.examReadingType5') }}" class="text-decoration-none">
                    <button type="button" class="btn btn-md btn-outline-primary"><i
                            class="fas fa-angle-double-left"></i></button>
                </a>

                <a href="{{ route('user.examReadingType7') }}">
                    <button type="button" class="btn btn-md btn-outline-primary"><i
