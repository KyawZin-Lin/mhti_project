                            ...
                            <div class="d-flex justify-content-between">
                                <div class="btn-print">
                                    ...
                                    <a href="{{ route('admin.alumnus') }}"><button type="button"
                                            class="btn btn-md btn-info">Alumni</button></a>

                                    {{-- <a href="{{ route('admin.oversea') }}"><button type="button"
                                            class="btn btn-md btn-info">Oversea</button></a> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="table-responsive">
                                        <table class="table table-strip">
                                            ...
                                            @php $future_interests = explode(',',$student->future_interest) @endphp
                                            @foreach ($future_interests as $future_interest)
                                                <tr>
                                                    <td>✔ {{ $future_interest }}</td>
                                                </tr>
                                            @endforeach
                                ...
                                <div class="col-sm-6">
                                    <div class="table-responsive">
                                        <table class="table table-strip">
                                            <tr>
                                                <td colspan="2"><b>Source Survey</b></td>
                                            </tr>
                                            @php $source_surveys = explode(',',$student->source_survey) @endphp
                                ...
                                <div class="col-sm-12">
                                    <div class="table-responsive">
                                        <table class="table table-strip">
                                            <tr>
                                                <td>{{ $student->oversea == 'Oversea' ? '✔ Oversea' : '✖ Oversea' }}</td>
                                                <td>Remark: {{ $student->remark }}</td>
                                            </tr>
