                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Edit Teacher Attendance</b></p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.teacher_attendances.update', $teacher_attendance->id) }}"
                                        ...
                                        <select name="teacher_id" id="teacher_id" class="myselect form-control">
                                            ...
                                            @foreach ($teachers as $teacher)
                                                <option value="{{ $teacher->id }}"
                                                    @if ($teacher->id == $teacher_attendance->teacher_id) selected @endif>
