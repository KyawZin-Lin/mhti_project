                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Edit Future Interest</b></p>

                                <a href="{{ route('admin.future_interests.index') }}">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.future_interests.update', $future_interest->id) }}" method="POST"
                                autocomplete="off">
                                @csrf
                                @method('PUT')
