                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Create Office Registration</b></p>
                            ...
                            <form action="{{ route('admin.registrations.store') }}" method="POST" autocomplete="off">
                                ...
                                <div class="list">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group row">
                                                <label for="code" class="col-sm-5 col-form-label text-right"><b>
                                                        Code</b></label>
                                                <div class="col-sm-7">
                                                    <input type="text" name="code[]" id="code"
                                                        class="form-control" value="{{ old('code.0') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-group row">
                                                <label for="title" class="col-sm-5 col-form-label text-right"><b>
                                                        Description</b></label>
                                                <div class="col-sm-7">
                                                    <textarea name="title[]" id="title" cols="30" rows="1" class="form-control">{{ old('title.0') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group row">
                                                <label for="amount"
                                                    class="col-sm-5 col-form-label text-right"><b>Amount</b></label>
                                                <div class="col-sm-7">
                    ...
                    <div class="col-sm-5">
                        <div class="form-group row">
                            <label for="title" class="col-sm-5 col-form-label text-right"><b>
                                    Description</b></label>
                            <div class="col-sm-7">
                                <textarea name="title[]" id="title" cols="30" rows="1" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
