                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Edit Office Registration</b></p>
                            ...
                            <form action="{{ route('admin.registrations.update', $income->id) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <p class="batch">
                                            {{ $income->student->batch != null ? $income->student->batch->batch : '' }}</p>
                                        </p>
                                    </div>
                                </div>
                                ...
                                @foreach ($income_details as $income_detail)
                                    <input type="hidden" name="income_detail_id[]" value="{{ $income_detail->id }}">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label for="code" class="col-sm-4 col-form-label text-right"><b>
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="code[]" id="code"
                                                        class="form-control" value="{{ $income_detail->code }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label for="title" class="col-sm-6 col-form-label text-right"><b>
                                                        Description</b></label>
                                                <div class="col-sm-6">
                                                    <input type="text" name="title[]" id="title"
                                                        class="form-control" value="{{ $income_detail->description }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group row">
                                                <label for="amount"
                                                    class="col-sm-4 col-form-label text-right"><b>Amount</b></label>
                                                <div class="col-sm-6">
                                                    <input type="number" name="amount[]" id="amount"
                                                        class="form-control" value="{{ $income_detail->amount }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
