                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Create Academic Year</b></p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.academic_years.store') }}" method="POST" autocomplete="off">
                                @csrf
                                        ...
                                        <select class="myselect form-control" name="degree_id">
                                            ...
                                            @foreach ($degrees as $degree)
                                                <option value="{{ $degree->id }}"
                                                    @if ($degree->id == old('degree_id')) selected @endif>{{ $degree->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
