        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12 d-flex justify-content-between mb-4 title-bar">
                    ...
                    <a href="{{ route('admin.payment_types.create') }}"><button type="button"
                            class="btn btn-md btn-success"><b><i class="fas fa-plus-square"></i>
                                New Payment Type</b></button></a>
                </div>
                <div class="col-sm-2">
                    <h5>Total - {{ count($payment_types) }}</h5>
                </div>
                <div class="col-sm-10">
                    <form action="{{ route('admin.payment_types.index') }}" method="GET">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-sm-7 m-0 p-0">
                                        ...
                                        <input type="text" name="search" id="search" class="form-control bg-white"
                                            value="{{ request()->search }}" placeholder="Search Payment Type...">
                                    </div>
                ...
                <div class="col-sm-12">
                            ...
                            <tbody>
                                @foreach ($payment_types as $payment_type)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.payment_types.edit', $payment_type->id) }}"><button
                                                    class="btn btn-sm btn-warning float-left mr-1">Edit</button></a>

                                            <form action="{{ route('admin.payment_types.destroy', $payment_type->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="float-right">
                        {{ $payment_types->withQueryString()->links() }}
                    </div>
                </div>
