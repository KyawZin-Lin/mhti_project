                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Create Medical Status</b></p>

                                <a href="{{ route('admin.medical_statuses.index') }}">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.medical_statuses.store') }}" method="POST" autocomplete="off">
                                @csrf
