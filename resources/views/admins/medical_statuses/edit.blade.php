                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Edit Medical Status</b></p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.medical_statuses.update', $medical_status->id) }}" method="POST"
                                autocomplete="off">
                                @csrf
                                @method('PUT')
