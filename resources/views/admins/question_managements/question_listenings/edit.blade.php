                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Edit Question (L)</b></p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.question_listenings.update', $question->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-9 col-md-9">
                                                <textarea name="question_name" id="question_name" class="form-control" cols="30" rows="2">{{ $question->question_name }}</textarea>
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <select name="listening_type" id="listening_type"
                                                    ...
                                                    <option></option>
                                                    <option value="1"
                                                        @if (1 == $question->listening_type) selected @endif>1</option>
                                                    <option value="2"
                                                        @if (2 == $question->listening_type) selected @endif>2</option>
                                                    <option value="3"
                                                        @if (3 == $question->listening_type) selected @endif>3</option>
                                                    <option value="4"
                                                        @if (4 == $question->listening_type) selected @endif>4</option>
                                                    <option value="5"
                                                        @if (5 == $question->listening_type) selected @endif>5</option>
                                                    <option value="6"
                                                        @if (6 == $question->listening_type) selected @endif>6</option>
                                                    <option value="7"
                                                        @if (7 == $question->listening_type) selected @endif>7</option>
                                                    <option value="8"
                                                        @if (8 == $question->listening_type) selected @endif>8</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group row mt-3">
                                                ...
                                                <div class="col-sm-8 col-md-8">
                                                    <textarea name="answer1" id="ans-one" class="form-control" cols="30" rows="2">{{ $question->answer1 }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="form-group row mt-3">
                                                <label for=""
                                                    class="col-sm-4 col-md-4 text-md-end text-right"><b>Answer
                                                        2</b></label>
                                                <div class="col-sm-8 col-md-8">
                                                    <textarea name="answer2" id="ans-two" class="form-control" cols="30" rows="2">{{ $question->answer2 }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group row mt-3">
                                                <label for=""
                                                    class="col-sm-4 col-md-4 text-md-end text-right"><b>Answer
                                                        3</b></label>
                                                <div class="col-sm-8 col-md-8">
                                                    <textarea name="answer3" id="ans-three" class="form-control" cols="30" rows="2">{{ $question->answer3 }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="form-group row mt-3">
                                                <label for=""
                                                    class="col-sm-4 col-md-4 text-md-end text-right"><b>Answer
                                                        4</b></label>
                                                <div class="col-sm-8 col-md-8">
                                                    <textarea name="answer4" id="ans-four" class="form-control" cols="30" rows="2">{{ $question->answer4 }}</textarea>
                                                </div>
                                            </div>
                                        </div>
