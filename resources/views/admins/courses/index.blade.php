                            ...
                            <tbody>
                                @foreach ($courses as $course)
                                    <tr>
                                        ...
                                        <td>
                                            <audio controls>
                                                <source src="{{ asset('audios/courses/' . $course->audio_file) }}"
                                                    type="audio/mp3">
                                                <source src="{{ asset('audios/courses/' . $course->audio_file) }}"
                                                    type="audio/m4a">
                                        ...
                                        <td>{{ $course->academicYear != null ? $course->academicYear->name : '' }}</td>
