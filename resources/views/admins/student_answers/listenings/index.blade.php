    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-10">
                    {{-- <form action="{{ route('admin.student_answers_listenings.index') }}" method="GET">
                        @csrf
                                ...
                                @foreach ($student_answers as $student_answer)
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:150px;">
                                            <a href="{{ route('admin.sa_detail_list', $student_answer->student_id) }}"><button
                                                    class="btn btn-sm btn-warning float-left mr-1">Detail</button></a>


                                            <form
                                                action="{{ route('admin.student_answers_listenings.destroy', $student_answer->student_id) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
