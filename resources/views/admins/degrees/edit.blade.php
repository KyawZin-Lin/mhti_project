                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Edit Course</b></p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.degrees.update', $degree->id) }}" method="POST"
                                ...
                                <div class="form-group row mt-3">
                                    <label for="" class="col-sm-4 col-md-4 text-md-end text-right"><b>Course
                                            Name</b></label>
                                ...
                                <div class="form-group row mt-3">
                                    <label for=""
                                        class="col-sm-4 col-md-4 text-md-end text-right"><b>Abbreviation</b></label>
                                    <div class="col-sm-6 col-md-6">
