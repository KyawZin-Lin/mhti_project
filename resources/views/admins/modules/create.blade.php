                    ...
                    <div class="card mt-3">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <p class="mt-3"><b>Create Module</b></p>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.modules.store') }}" method="POST" autocomplete="off">
                                @csrf
                                        ...
                                        <select class="myselect form-control" name="course_id">
                                            ...
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    @if ($course->id == old('course_id')) selected @endif>{{ $course->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row my-3 mb-5">
                                    <div class="col-3 offset-4">
                                        <button type="button" class="btn btn-sm btn-secondary w-100">Cancel</button>
                                    </div>
